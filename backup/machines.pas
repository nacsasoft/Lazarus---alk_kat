...
begin
  ...
  if (iMachineType = 17) then
  begin
       //pipetta kereséskor nem 'Megnevezés' hanem 'Pipetta típusa' a fejléc
       dbgPartsList.Columns.Items[2].Title.Caption := 'Pipetta típusa';
  end
  else
      dbgPartsList.Columns.Items[2].Title.Caption := 'Megnevezés';
